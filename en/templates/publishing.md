...
> See also: [Development Guide](dev-guide.md) · [CLI Manual](../cli/cli.md) · [SDK Reference](../sdk/sdk-reference.md)
...
See the [CLI manual](../cli/cli.md#2-installing-from-the-marketplace).
