...
> [velashell-plugin-cli](../cli/release-process.md),
> `dotnet new` 模板见
> [velashell-plugin-templates](../templates/release-process.md)。
...
```
Directory.Build.props: <VelaAvaloniaVersion>12.1.3</VelaAvaloniaVersion>
